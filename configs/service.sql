...
CREATE DATABASE IF NOT EXISTS service_template DEFAULT CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_general_ci;
...
(
    ...
    `profile_photo` varchar(255) DEFAULT '' COMMENT '头像图片位置',
